...
function redirectToPage(event) {
    ...
    if (email === "ao-mchs@mc.edu.ph" && password === "ao2025") {
        window.location.href = "MCHS_III_GROUP 2_AO RESERVATION_AO_APPROVAL.html";
    }
    else if (email === "student@mc-knoller.edu.ph" && password === "student2025") {
        window.location.href = "MCHS_III_GROUP 2_AO RESERVATION_RESERVE A ROOM.html";
    }
    else if (email === "mchsapsa@mc.edu.ph" && password === "apsa2025") {
        window.location.href = "MCHS_III_GROUP 2_AO RESERVATION_CONF_CONFIRMATION.html";
    }
    else if (email === "teacher@mc.edu.ph" && password === "teacher2025") {
        window.location.href = "MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_RESERVE A ROOM.html";
    }
    else {
