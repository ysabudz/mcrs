    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto">
                   ...
                   <b> <li class="nav-item"><a class="active" href="MCHS_III_GROUP 2_AO RESERVATION_CONF_LOG OUT.php"style ="text-decoration: underline">Log out</a></li> </b>
                </ul>
            </div>
        </div>
    </nav>
...
<div class="grey-box1">
    ...
    <div class="wrapper">
        ...
        <!--cancel button-->
        <a href = "MCHS_III_GROUP 2_AO RESERVATION_CONF_CONFIRMATION.php";> <button class="button"style="text-decoration:underline; float:right;"> Cancel </button> </a>
    </div>
    </div>
    </div>
</div>
