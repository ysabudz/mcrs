        ...
        <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                   <b> <li class="nav-item"><a class="nav-link" href="MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_RESERVE A ROOM.php" style ="text-decoration: underline" >Reserve a Room</a></li> </b>
                    ...
                    <b> <li class="nav-item"><a class="active" href="MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_LOG OUT.php"style ="text-decoration: underline">Log out</a></li> </b>
                </ul>
            </div>
        </div>
    </nav>
...
<div class="grey-box1">
    ...
    <div class="wrapper">
        ...
        <!--cancel button-->
        <a href = "MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_RESERVE A ROOM.php";> <button class="button"style="text-decoration:underline; float:right;"> Cancel </button> </a>
    </div>
    </div>
    </div>
</div>
