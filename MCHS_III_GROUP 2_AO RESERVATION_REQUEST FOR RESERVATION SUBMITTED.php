...
<div class="grey-box1">
    ...
    <div class="wrapper">
        <div class="confirmation-box">
            <p style="font-family: 'Poppins', sans-serif;letter-spacing: 1.5px; font-size: 32px;"><b>Request for Reservation Submitted!</b></p>
            <p style="font-family: 'Poppins', sans-serif;letter-spacing: 1.5px; font-size: 26px;">
                Please refer to your inbox in the <br> 'My Account' tab to view the status of your <br> request.
            </p>
        </div>
    </div>
