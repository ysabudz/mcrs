    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto">
                   ...
                   <b> <li class="nav-item"><a class="nav-link" href="MCHS_III_GROUP 2_AO RESERVATION_CONF_CONFIRMATION.php" style ="text-decoration: underline" >Confirmation</a></li> </b>
                   ...
                   <b> <li class="nav-item"><a class="active" href="MCHS_III_GROUP 2_AO RESERVATION_CONF_MY ACCOUNT.php" style ="text-decoration: underline">My Account</a></li> </b>
...
<!-- Grey Background Area --> <div class="grey-box1">
        <div class="profile-container">
            <div class="profile-pic">
                <img class="profile-pic" alt="Profile Picture" style="text-align: center; background-color: blue; width: 100%; height: 100%%;">
            </div>
            <div class="profile-box">
                <div class="profile-text">
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>Name: Sherill Alvarez</b> </p>
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>ID No.: XXXXXX</b> </p>
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>Position: Assistant Principal for Student Affairs</b> </p>
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>Email Address: apsa@mc.edu.ph</b> </p>
                </div>
            </div>
        </div>
