        ...
        <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                   <b> <li class="nav-item"><a class="nav-link" href="MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_RESERVE A ROOM.php" style ="text-decoration: underline" >Reserve a Room</a></li> </b>
                    ...
                    <b> <li class="nav-item"><a class="nav-link" href="MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_ACKNOWLEDGEMENT.php" style ="text-decoration: underline" >Acknowledgement</a></li> </b>
                    ...
                    <b> <li class="nav-item"><a class="active" href="MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_MY ACCOUNT.php" style ="text-decoration: underline">My Account</a></li> </b>
...
<!-- Grey Background Area --> <div class="grey-box1">
        <div class="profile-container">
            <div class="profile-pic">
                <img class="profile-pic" src="pfp1.png" alt="Profile Picture" style="text-align: center; background-color: blue; width: 100%; height: 100%%;">
            </div>
            <div class="profile-box">
                <div class="profile-text">
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>Name: Christina Budikey</b> </p>
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>ID No.: 0110007</b> </p>
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>Subject Area: STEM Strand - General Physics</b> </p>
                <p style="font-family: 'Poppins', sans-serif; letter-spacing: 1px; font-size: 24px;"> <b>Email Address: teacher@mc.edu.ph</b> </p>
                </div>
            </div>
        </div>
...
<tbody>
    <tr>
        <td>Status of request for Computer Laboratory A on April 21, 9:30AM - 10:30AM</td>
        <td>PENDING</td>
    </tr>
    <tr>
