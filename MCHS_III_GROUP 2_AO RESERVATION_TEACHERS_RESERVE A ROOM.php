            ...
            <div class="container-fluid">
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            <b> <li class="nav-item"><a class="active" href="MCHS_III_GROUP 2_AO RESERVATION_TEACHERS_RESERVE A ROOM.php" style ="text-decoration: underline" >Reserve a Room</a></li> </b>
        ...
        <div class="page-container">
            ...
            <div class="wrapper">
                ...
                <div class="instructions">
                    <p style="margin-top: -1px; text-align: center; font-size: 27px"><b> How to Use the Website </b></p>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function populateVenueSubMenu(categoryDiv, venues) {
        ...
        subMenu.classList.add('sub-menu', 'show-submenu');
    ...
    function toggleVenueDropdown() {
        venueDropdownDiv.classList.toggle('show');
        if (venueDropdownDiv.classList.contains('show')) {
            populateVenueCategories(venueDropdownDiv, venuesByCategory);
        }
    }

    venueButton.addEventListener('click', function (event) {
        event.stopPropagation();
        toggleVenueDropdown();
    });
    ...
    window.addEventListener('click', function (event) {
        if (!event.target.closest('.dropdown-button')) {
            venueDropdownDiv.classList.remove('show');
            const subMenus = venueDropdownDiv.querySelectorAll('.sub-menu');
    ...
    reservationForm.addEventListener('submit', function (event) {
        ...
        const venueValue = hiddenVenueInput.value.trim();
        if (!venueValue) {
        ...
        displayPopup("Request Submitted!", "Check your 'My Account' tab to view your request status.", () => {
